...
from rewards import compute_reward_det_coff, compute_reward_coff, compute_reward, dispatch_reward, REWARD_DESCRIPTIONS
import numpy as np
import random
...
parser.add_argument('--save_path', type=str, default=r'd:\PycharmProjects\TAS-Net\TAS-output\SEED\session1', help='output directory and fragments')
...
parser.add_argument('--reward_type', type=str, default='original',
                    choices=['original', 'r1', 'r2', 'r3', 'r4'],
                    help='Reward function to use: original | r1 | r2 | r3 | r4')
...
if __name__ == '__main__':
    if args.training:
        ...
        print("Reward Function : {}".format(args.reward_type))
        print("Reward Description: {}".format(REWARD_DESCRIPTIONS.get(args.reward_type, 'Unknown')))
        print("==================================================")
        ...
        for epoch in range(start_epoch, args.epochs):
            ...
            for idx in idxs:
                ...
                for episode in range(5):
                    ...
                    reward = dispatch_reward(args.reward_type, seq, actions, args.num_fragment)
